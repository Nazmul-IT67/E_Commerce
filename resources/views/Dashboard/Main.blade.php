                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="image/{{ Auth::user()->image }}" alt="assets." class="img-circle profile_img">
                        </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li class="@yield('dashboard')"><a href="{{ url('dashboard') }}"><i class="fa fa-home"></i> Home</a>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Category<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ url('category-add') }}">Category Add</a></li>
                                        <li><a href="{{ url('category-list') }}">Category List</a></li>
                                        <li><a href="{{ url('trash-list') }}">Trash Category</a></li>
                                    </ul>
                                </li>
                        ...
                        <ul class="navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="image/{{ Auth::user()->image }}"
                                        alt="">{{ Auth::user()->name ?? 'N/A' }}
                                </a>
                                <div style="width: 20px; border-radius:5px; margin-top:20px;" class="dropdown-menu dropdown-usermenu pull-right"
