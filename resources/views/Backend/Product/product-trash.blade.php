                                            ...
                                            <div class="col-sm-12">
                                                <table class="table table-striped table-bordered dataTable no-footer">
                                                    ...
                                                    <tbody class="text-center">
                                                        @foreach ($trashProduct as $key=> $user)
                                                            <tr>
                                                                <td>{{ $trashProduct->firstItem() +$key}}</td>
                                                                <td>{{ $user->title }}</td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('ProductRestor',$user->id) }}"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
                                                                    <a href="{{ route('ProductSoft',$user->id) }}"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
