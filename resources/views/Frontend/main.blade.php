                    ...
                    <div class="featured-active2 owl-carousel next-prev-style">
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="front/assets/images/featured/6.jpg" alt="">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="front/assets/images/featured/7.jpg" alt="">
                                <div class="featured-content">
                        ...
                        <div class="featured-wrap">
                            <div class="featured-img">
                                <img src="front/assets/images/featured/8.jpg" alt="">
                                <div class="featured-content">
            ...
            <ul class="row">
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/15.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>New</span>
                            <img src="front/assets/images/product/11.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/14.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>New</span>
                            <img src="front/assets/images/product/12.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/10.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>New</span>
                            <img src="front/assets/images/product/9.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/8.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>New</span>
                            <img src="front/assets/images/product/7.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/6.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <li class="col-xl-3 col-lg-4 col-sm-6 col-12  moreload">
                    <div class="product-wrap">
                        <div class="product-img">
                            <span>Sale</span>
                            <img src="front/assets/images/product/5.jpg" alt="">
                            <div class="product-icon flex-style">
                                <ul>
                                    <li><a data-toggle="modal" data-target="#exampleModalCenter"
                                            href="javascript:void(0);"><i class="fa fa-eye"></i></a></li>
                ...
                <div class="col-md-10 offset-md-1 col-12">
                    <div class="testmonial-active owl-carousel">
                        <div class="test-items test-items2">
                            ...
                            <div class="test-img2">
                                <img src="front/assets/images/test/1.png" alt="">
                            </div>
                        </div>
                        <div class="test-items test-items2">
                            <div class="test-content">
