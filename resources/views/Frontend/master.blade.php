...
<head>
    ...
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="front/assets/css/metisMenu.min.css">
    <!-- swiper.min.css -->
...
<body>
                        ...
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="front/assets/images/cart/1.jpg" alt="">
                                        </div>
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="front/assets/images/cart/3.jpg" alt="">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html">Pure Nature Product</a>
                                            <span>QTY : 1</span>
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="front/assets/images/cart/2.jpg" alt="">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html">Pure Nature Product</a>
                                            <span>QTY : 1</span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex">
                    <div class="product-single-img w-50">
                        <img src="front/assets/images/product/product-details.jpg" alt="">
                    </div>
    ...
    <!-- scrollup.js -->
    <script src="front/assets/js/scrollup.js"></script>
    <!-- isotope.pkgd.min.js -->
    ...
    <!-- metisMenu.min.js -->
    <script src="front/assets/js/metisMenu.min.js"></script>
    <!-- mailchimp.js -->
    <script src="front/assets/js/mailchimp.js"></script>
    <!-- jquery-ui.min.js -->
